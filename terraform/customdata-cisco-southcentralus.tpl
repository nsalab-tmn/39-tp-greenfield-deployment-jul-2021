...
!
ip nat inside source static tcp 10.3.10.6 443 interface GigabitEthernet1 443
ip nat inside source static tcp 10.3.10.6 80 interface GigabitEthernet1 80
