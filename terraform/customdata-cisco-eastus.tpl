...
!
ip nat inside source static tcp 10.1.10.6 80 interface GigabitEthernet1 80
ip nat inside source static tcp 10.1.10.6 443 interface GigabitEthernet1 443
